...
//               <i className="fas fa-chart-line me-2" style={{ color: '#0052CC' }}></i>
//               Compliance Insights
//             </h5>
//             <p className="text-muted small">AI-generated insights from compliance data and KPIs</p>
//             <div style={{ height: '200px' }}>
//               <Line data={complianceData} options={{ maintainAspectRatio: false }} />
//             </div>
//           </div>
//         </div>
//       </div>
...
//           <div className="card-body">
//             <h5 className="card-title d-flex align-items-center">
//               <i className="fas fa-hard-hat me-2" style={{ color: '#0052CC' }}></i>
//               Safety Reports
//             </h5>
//             <p className="text-muted small">AI-generated summaries of safety reports and status indicators</p>
//             <div style={{ height: '200px' }}>
//               <Line data={safetyData} options={{ maintainAspectRatio: false }} />
//             </div>
//           </div>
//         </div>
//       </div>
...
//           <div className="card-body">
//             <h5 className="card-title d-flex align-items-center">
//               <i className="fas fa-bell me-2" style={{ color: '#0052CC' }}></i>
//               Real-Time Alerts
//             </h5>
...
//               <p className="small mb-0">Unusual activity detected in Zone 8</p>
//             </div>
...
//         <i className="fas fa-bolt me-2" style={{ color: '#0052CC' }}></i>
//         Quick Actions
//       </h5>
...
//           <i className="fas fa-share me-2"></i>Share Review
//         </button>
//         <button className="btn border-primary text-primary">
//           <i className="fas fa-cog me-2"></i>Customize Categories
//         </button>
...
//                 <i className={`fas fa-${icon} me-2`}></i>{title}
//               </h6>
...
//                     id={`${key}-${subKey}`}
//                   />
//                   <label className="form-check-label" htmlFor={`${key}-${subKey}`}>
//                     {subKey.replace('_', ' ')}
//                   </label>
//                 </div>
//               ))}
