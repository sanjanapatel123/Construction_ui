...
//               })
//               .catch(() => {
//                 toast.error("Failed to update site review!");
//               });
...
// import { fetchsitereviewById } from '../../../redux/slices/sitereviewSlice';
// import { fetchSiteEntries } from '../../../redux/slices/siteEntrySlice';
// import { toast, ToastContainer } from "react-toastify";
// import "react-toastify/dist/ReactToastify.css";
...
//   const { id } = useParams();
//   const reviewId = id;
//   console.log(reviewId); // to determine if it's edit mode
