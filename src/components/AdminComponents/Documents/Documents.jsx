...
//                   'success'
//                 );
//                 dispatch(fetchDocuments());  // Refresh the table after delete
//               })
//               .catch((error) => {
//                 Swal.fire(
//                   'Error!',
...
//     )
//       return false;
//     if (selectedFilter !== "all" && doc.status.toLowerCase() !== selectedFilter.toLowerCase())
//       return false;
//     return true;
//   });
...
//       setFormData({
//         ...formData,
//         image: files[0],  // Save the first file
//       });
//     } else {
//       setFormData({
//         ...formData,
...
//                               </td>
//                               <td className="py-3">
//                               {new Date(doc.submissionDate).toISOString().split('T')[0]}
//                               </td>
//                               <td className="py-3">
//                               {new Date(doc.dueDate).toISOString().split('T')[0]}
//                               </td>
//                               <td className="py-3">{doc.assignTo}</td>
...
//                                 </button> */}
//                                 <button className="btn p-0 me-2" onClick={() => HandleDelete(doc._id)}>
...
//           <Modal.Title>
//             {editingDocument ? "Edit Document" : "Submit New Document"}
//           </Modal.Title>
//         </Modal.Header>
//         <Modal.Body>
...
//                 {editingDocument ? "Update Document" : "Submit Document"}
//               </Button>
//             </Modal.Footer>
//           </Form>
//         </Modal.Body>
