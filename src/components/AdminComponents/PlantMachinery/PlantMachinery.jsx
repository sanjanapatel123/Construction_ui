          ...
          <div className="bg-white p-4 rounded shadow-sm">
            ...
            <div className="table-responsive shadow-sm bg-white rounded">
              <table className="table table-hover table-bordered table-striped align-middle mb-0">
                ...
                <tbody className="p-2">
                  {tools.map((tool) => (
                    <tr key={tool.id} className="py-3">
                      <td className="ps-4 py-3">{tool.id}</td>
                      ...
                      <td className="py-3">{tool.currentUser || "-"}</td>
                      <td className="py-3">{tool.checkoutDate || "-"}</td>
                      <td className="py-3">{tool.expectedReturn || "-"}</td>
                      <td className="pe-4 py-3">
                        <div className="d-flex gap-2">
                          {tool.status === "Available" ? (
                            <button
